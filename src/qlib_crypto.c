...
void QLIB_CRYPTO_BuildCipherKey(QLIB_HASH_BUF_T hashBuf, U8 key_id, QLIB_DIRECTION_E dir, _256BIT cipher_key)
{
    ...
    /* Perform HASH                                                                                        */
    /*-----------------------------------------------------------------------------------------------------*/
    PLAT_HASH(cipher_key, hashBuf, QLIB_CRYPTO_HASH_BUFFER_SIZE);
}
...
void QLIB_CRYPTO_BuildCipherKey_Async(QLIB_HASH_BUF_T hashBuf, U8 key_id, QLIB_DIRECTION_E dir, _256BIT cipher_key)
{
    ...
    /* Perform SHA                                                                                         */
    /*-----------------------------------------------------------------------------------------------------*/
    PLAT_HASH_Async(cipher_key, hashBuf, QLIB_CRYPTO_HASH_BUFFER_SIZE);
}
#endif
...
void QLIB_CRYPTO_CalcAuthSignature(QLIB_HASH_BUF_T hashBuf, const U8 key_id, _64BIT signature)
{
    ...
    /* Perform HASH                                                                                        */
    /*-----------------------------------------------------------------------------------------------------*/
    PLAT_HASH(hash_result, hashBuf, QLIB_CRYPTO_HASH_BUFFER_SIZE);
                                 ...
                                 KEY_T       prov_key_128_bit)
{
    ...
    /* Perform HASH                                                                                        */
    /*-----------------------------------------------------------------------------------------------------*/
    PLAT_HASH(hash_result, hash_buf, QLIB_CRYPTO_HASH_BUFFER_SIZE);
